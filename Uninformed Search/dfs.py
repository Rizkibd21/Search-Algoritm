...
Original file is located at
    https://colab.research.google.com/drive/1ND6g4XcJimmngt_7jgbLS5sliPFh6Wc7
"""

#Phyton3 program to print DFS traversal
#from a given graph
...
class Graph:
  ...
  def DFSUtil(self,v,visited):
    ...
    #Tandai node saat ini sebagai yang telah dikunjungi
    #dan cetak
    visited.add(v)
    print(v,end=' ')
  ...
  #Fungsi untuk melakukan DFS. Ini menggunakan DFSUtil() rekursif
  def DFS(self, v):

    #Buat himpunan untuk menyimpan node yang sudah dikunjngi
    visited = set()

    #Panggil fungsi bantu rekursif untuk mencetak penulusar DFS
